...
<input type="text" disabled name="_speaker_video_id" id="speaker_video_id" style="width: 95%;" value="<?=  $speaker_video_id; ?>"/>
...
<p style="color: red">Este campo ficará desabilitado. Após a apresentação, cadastre um vídeo em <strong>Talks > Add New</strong>.</p>